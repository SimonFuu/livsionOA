            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <!--- officeTel Field --->
                        <div class="form-group {{ $errors -> has('officeTel') ? 'has-error' : '' }}">
                            {!! Form::label('officeTel', '办公电话:', ['class' => 'col-sm-2 control-label']) !!}
                            <div class="col-sm-10">
                                {!! Form::text('officeTel', is_null($userProfile) ? null : $userProfile -> officeTel, ['class' => 'form-control', 'placeholder' => '办公电话！']) !!}
                                @if($errors -> has('officeTel'))
                                    <span class="help-block form-help-block">
                                <strong>{{ $errors -> first('officeTel') }}</strong>
                            </span>
                                @endif
                            </div>
                        </div>
